...
import { pastCases, type PastCase } from "@/lib/mock-past-cases";
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground">
          Review previous ICD-10 code validations and outcomes
        </p>
      </div>
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        ...
        <CollapsibleContent>
          <CardContent className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground mb-2">
                Clinician Labeled Codes (Existing)
              </h3>
              <div className="flex flex-wrap gap-2">
                {pastCase.existingCodes.map((code) => (
                  <Badge
                    key={`${pastCase.id}-${code}`}
                    variant="secondary"
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground mb-2">
                Accepted Codes (Final)
              </h3>
              {pastCase.acceptedCodes.length > 0 ? (
                <div className="flex flex-wrap gap-2">
